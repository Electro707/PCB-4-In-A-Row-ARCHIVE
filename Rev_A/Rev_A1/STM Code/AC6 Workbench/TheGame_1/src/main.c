...
#define PLAYER1COLOR CYAN
#define PLAYER2COLOR PURPLE
...
int main(void)
{
	...
	while(1){
		if(active_player == 1){INDICATE_CYAN}else{INDICATE_PURPLE} // Turn on the indicator LED depending on who is the active player
